...
// const filter_repoLanguage = require("./filter_repoLanguage.js");
// const filter_repoLanguage_prompt = require("./filter_repoLanguage_prompt.js");
...
const dupes_main = require("./dupes_removal/dupes_main.js");
const prompt_array = require("./prompt_array.js");
const prompts = require("./results/dupes_removed/CONCAT_0727.json");
const language_detection = require("./language_detection.js");
...
//   }
//   file_writer(`./new_filter/entries/${name}`, JSON.stringify(mainObject));
// });
// .forEach(([importedFile, name]) => {
//   for (importFile in importedFile) {
//     file_writer(
//       `./new_filter/entries/${name}_${importFile}`,
//       JSON.stringify(filter_repoLanguage(importedFile[importFile])),
//     );
//   }
// });
// .forEach(([importedFile, name]) => {
//   for (importFile in importedFile) {
//     file_writer(
//       `./new_filter/prompt/${name}_${importFile}`,
//       JSON.stringify(filter_repoLanguage_prompt(importedFile[importFile])),
//     );
//   }
// });
...
// file_writer(
//   `./results/dupes_removed/CONCAT_2707_FIRST`,
//   JSON.stringify(prompt_array(prompts)),
// );
